...
The previous PA scraper reached only the a commercial mirror after the official host was thought unreachable, and it
...
therefore differ from the legacy hyphen-form ones only by the decimal
